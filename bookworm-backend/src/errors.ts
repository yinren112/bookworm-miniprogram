...
export const StudyErrorCodes = {
  ...
  CARD_CONTENT_ID_NOT_UNIQUE: 'CARD_CONTENT_ID_NOT_UNIQUE',
  CARD_DAILY_LIMIT_REACHED: 'CARD_DAILY_LIMIT_REACHED',
  QUESTION_NOT_FOUND: 'QUESTION_NOT_FOUND',
  WRONG_ITEM_NOT_FOUND: 'WRONG_ITEM_NOT_FOUND',
  CHEATSHEET_NOT_FOUND: 'CHEATSHEET_NOT_FOUND',
  INVALID_EXAM_DATE: 'INVALID_EXAM_DATE',
  INVALID_ACTIVITY_DATE: 'INVALID_ACTIVITY_DATE',
  ACTIVITY_DATE_IN_FUTURE: 'ACTIVITY_DATE_IN_FUTURE',
  ACTIVITY_DATE_TOO_OLD: 'ACTIVITY_DATE_TOO_OLD',
